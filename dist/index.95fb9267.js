...
`,setTimeout(()=>{c()},100);let t=document.getElementById("form-create"),n=document.getElementById("form-difficulty");n.querySelector('input[name="difficulty"]:checked').value,t.addEventListener("submit",d),n.addEventListener("submit",m)},o=()=>{let e,t,o,a=+randomMonster.HP,r=+randomMonster.damage,i=document.getElementById("monster-hp"),s=document.getElementById("player-hp"),d=document.getElementById("att-btn"),m=document.getElementById("heavy-att-btn"),u=document.getElementById("heal-btn"),f=document.getElementById("retry-btn"),y=document.getElementById("home-btn"),v=n=>{i.max=n,i.value=n,e=n,s.max=100,s.value=100,t=100,o=!0},h=()=>Math.round((Math.random()-.5)*10),b=()=>{let e=r+h();e<0&&(e=0),t-=e,s.value=t},g=()=>{let t=10+h();e-=t,i.value=e,b(),L()},p=()=>{let t=18+h();e-=t,i.value=e,b(),L()||(b(),L())},E=()=>{o?((t+=45+h())>=100&&(t=100),s.value=t,o=!1,b(),L()):l("No healing uses left","stay")},L=()=>e<=0&&t>=0?(l("You won!","stay"),v(a),!0):t<=0&&e>=0?(l("You lost!","stay"),v(a),!0):e<=0&&t<=0?(l("Draw!","stay"),v(a),!0):void 0;v(a),d.addEventListener("click",g),m.addEventListener("click",p),u.addEventListener("click",E),f.addEventListener("click",v.bind(void 0,a)),y.addEventListener("click",()=>{d.removeEventListener("click",g),m.removeEventListener("click",p),u.removeEventListener("click",E),f.removeEventListener("click",v.bind(void 0,a)),y.removeEventListener("click",n),c(),setTimeout(()=>{n()},600)})},a=document.getElementById("form-create"),r=document.getElementById("form-difficulty"),i="https://monster-rng-back.onrender.com",s=e=>{e.reset()},l=(e,t="timed")=>{let n=document.querySelector(".notification"),o=document.querySelector("#notificationType");n.classList.toggle("active"),o.classList.toggle("notificationText"),o.innerText=`${e}`;let a=()=>{o.innerText="",n.classList.toggle("active"),o.classList.toggle("notificationText"),window.removeEventListener("mouseup",a)};"stay"===t?window.addEventListener("mouseup",a):setTimeout(a,2e3)},c=()=>{document.querySelector(".up").classList.toggle("up-close"),document.querySelector(".down").classList.toggle("down-close")},d=e=>{e.preventDefault();let n=document.getElementById("form-create");fetch(`${i}/add-monster`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({name:n.name.value.toUpperCase(),HP:n.HP.value,damage:n.damage.value,difficulty:t(n.HP.value,n.damage.value)})}).then(e=>{if(400===e.status)throw Error("Too crazy monster stats");if(500===e.status)throw Error("Server is down");return e.json()}).then(e=>{if(!e.id){l("Monster has no ID"),s(n);return}l("Monster created!"),window.localStorage.setItem("last created",JSON.stringify(e.id)),s(n)}).catch(e=>{console.error(e),l(e)})},m=t=>{let n;t.preventDefault();let r=document.getElementById("form-difficulty"),s=r.querySelector('input[name="difficulty"]:checked').value;try{n=JSON.parse(window.localStorage.getItem("last created"))}catch(t){let e=`No last created monster found", ${t}`;console.error(e),l(e);return}"last"===s&&n?fetch(`${i}/lastcreated/${n}`).then(e=>{if(404===e.status)throw Error("Your last created monster escaped. Create another one");if(500===e.status)throw Error("Server is down");return e.json()}).then(t=>{window.randomMonster={name:t.name,HP:t.hp,damage:t.damage},a.removeEventListener("submit",d),r.removeEventListener("submit",m),c(),setTimeout(()=>{e(),o()},600)}).catch(e=>{console.error(e),l(e)}):fetch(`${i}/monster/${s}`).then(e=>{if(404===e.status)throw Error("Could not find monster with selected difficulty, please create more");if(500===e.status)throw Error("Server is down");return e.json()}).then(t=>{window.randomMonster={name:t.name,HP:t.hp,damage:t.damage},a.removeEventListener("submit",d),r.removeEventListener("submit",m),c(),setTimeout(()=>{e(),o()},600)}).catch(e=>{console.error(e),l(e)})};a.addEventListener("submit",d),r.addEventListener("submit",m);
//# sourceMappingURL=index.95fb9267.js.map
